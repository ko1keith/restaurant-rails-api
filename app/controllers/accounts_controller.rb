class AccountsController < ApplicationController
  ...
  def update
    ...
    @account.update(email: update_params[:email]) if update_params[:email]
    @account.update(first_name: update_params[:first_name]) if update_params[:first_name]
    @account.update(last_name: update_params[:last_name]) if update_params[:last_name]
